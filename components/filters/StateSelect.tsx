  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center justify-between">
        <label className="text-xs font-semibold uppercase tracking-wide text-black/70">States</label>
      ...
      <details className="rounded-md border border-slate-300 bg-white">
        <summary className="cursor-pointer list-none px-3 py-2 text-sm text-black marker:content-none">
          {selectedStates.length > 0
